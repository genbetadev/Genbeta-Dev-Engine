...
do { GDE::Log::Log(GDE::Log::Info, __FILE__, __LINE__, 0).reference() << MSG; } while(0)

#define GDE_LOG_DEBUG(MSG) \
do { GDE::Log::Log(GDE::Log::Debug, __FILE__, __LINE__, 0).reference() << MSG; } while(0)

#define GDE_LOG_WARNING(MSG) \
do { GDE::Log::Log(GDE::Log::Warning, __FILE__, __LINE__, 0).reference() << MSG; } while(0)

#define GDE_LOG_ERROR(MSG) \
do { GDE::Log::Log(GDE::Log::Error, __FILE__, __LINE__, 0).reference() << MSG; } while(0)
...
namespace GDE { namespace Log
{
    ...
    public:
         ...
         */
        Log& operator<< (Log& (*manipulator)(GDE::Log::Log&)) { return (*manipulator)(*this); }
    ...
    private:
        ...
        static GDE::Log::LogHandler handler;
    };
